...
function col8_shortcode( $atts , $content = null ) {
    ...
    extract( shortcode_atts(
     ...
     if ($offset) {
        $class = 'col-md-8 ' . 'col-md-offset-' . $offset;
    } else {
         $class = 'col-md-8';
     }
...
function slider_shortcode() {
    ...
    if ( $query->have_posts() ) {
        ...
        while ( $query->have_posts() ) {
            ...
            $out .= '</div>';
            $out .= '<h2 class="post-title" title="' . get_the_title() . '">' . get_the_title() . '</h2>';
            $out .= '</a>';
            $out .= '</div>';
        }
                     ...
                     if ($count == 1) {
                        ...
                        $out .= '<div class="row">';
                            ...
                            $out .= '<div class="col-md-12">';
                                ...
                                $out .= '<h2 class="post-title"><a href="' . get_the_permalink() . '" title="' . get_the_title() . '">' . get_the_title() . '</a></h2>';
